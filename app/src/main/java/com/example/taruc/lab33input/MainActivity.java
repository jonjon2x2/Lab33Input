...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void reset_premium(View view){
    ...
    public void calculatePremium(View view){
        int position;
        float premium = 0;
         Currency currrency = Currency.getInstance(Locale.getDefault());
         String symbol = currrency.getSymbol();
        ...
        textViewPremium.setText(symbol + " " + premium);
